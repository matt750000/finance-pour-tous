...
class ProductFixtures extends Fixture implements DependentFixtureInterface
{
    public function load(ObjectManager $manager): void
    {
        ...
        $product1->setImage('ebook-investissement.jpg');
        ...
        $product2->setImage('video-analyse.jpg');
        ...
        $product3->setImage('modele-budget.jpg');
        ...
        $product4->setImage('newsletter-premium.jpg');
